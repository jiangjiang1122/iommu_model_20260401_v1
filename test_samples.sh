...
echo "Compiling stats_collector.cpp..."
g++ $CXXFLAGS -c iommu/cache_src/common/stats_collector.cpp -o build/iommu/cache_src/common/stats_collector.o
...
echo "Running..."
./iommu_model 2>&1 | grep -A 30 "Latency Sample Counts"
