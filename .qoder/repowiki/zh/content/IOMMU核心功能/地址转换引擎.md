...
subgraph "测试验证"
O["test_rp_128k_two_stage_thread.cc<br/>两阶段转换测试"]
...
- [test_rp_128k_two_stage_thread.cc:1-347](file://rp/test_rp_128k_two_stage_thread.cc#L1-L347)
...
GAD --> GNAPOT{"NAPOT 叶子?"}
GNAPOT --> |是| GFixPPN["修正 PPN 为 GPA 映射范围"]
...
**图表来源**
- [test_rp_128k_two_stage_thread.cc:48-120](file://rp/test_rp_128k_two_stage_thread.cc#L48-L120)
...
#### 128KB 顺序读取测试
- **场景描述**：5000 个连续 512B 读请求，顺序步长 512B
- **验证目标**：两阶段转换的正确性和性能
...
**图表来源**
- [test_rp_128k_two_stage_thread.cc:130-325](file://rp/test_rp_128k_two_stage_thread.cc#L130-L325)
...
- **请求数量**：5000 个（两阶段测试） vs 1000 个（Sv48+Bare 测试）
- **数据大小**：512B 顺序步长
...
**章节来源**
- [test_rp_128k_two_stage_thread.cc:10-347](file://rp/test_rp_128k_two_stage_thread.cc#L10-L347)
...
TestRP["test_rp_128k_two_stage_thread.cc"] --> TestFunc["test_rp_func.cc"]
TestRP --> TwoStage
TestRP --> SecondStage
