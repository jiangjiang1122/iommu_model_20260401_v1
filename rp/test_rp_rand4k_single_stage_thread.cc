...
// ============================================================
// Test Scenario: 4KB Random Read + Single-Stage Address Translation
//   iosatp = Sv39, iohgatp = Bare
//   IOVA range: 16MB (0x100000 ~ 0x1100000), 4096 pages
//   PA = IOVA + 0x10000 (fixed offset)
//   500 unique random pages, shuffled access order
//   4000 requests (8 reqs/page x 500 pages), each 512B
// ============================================================
