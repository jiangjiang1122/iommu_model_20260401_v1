...
CacheSubsystem::CacheSubsystem(sc_module_name name, const GlobalConfig& cfg)
    : sc_module(name),
      ...
      dc_response_fifo(1),
      pc_response_fifo(1),
      pt_hit_response_fifo(1),
      pt_miss_response_fifo(1),
      ...
      invalidation_response_fifo(1)
{
    ...
    SC_THREAD(walker_worker_thread);
    ...
    SC_THREAD(walker_update_worker_thread);
    ...
    SC_THREAD(walker_invalidate_worker_thread);
