...
extern uint8_t read_memory(iommu_t *iommu, uint64_t addr, uint8_t size, char *data,
                           uint32_t rcid, uint32_t mcid, uint32_t pma, int endian);
extern uint8_t read_memory_for_AMO(iommu_t *iommu, uint64_t address, uint8_t size, char *data,
                                   uint32_t rcid, uint32_t mcid, uint32_t pma,
                                   int endian);
extern uint8_t write_memory(iommu_t *iommu, char *data, uint64_t address, uint32_t size,
                            uint32_t rcid, uint32_t mcid, uint32_t pma,
                            int endian);
extern uint8_t read_memory_test(iommu_t *iommu, uint64_t addr, uint8_t size, char *data);
extern uint8_t write_memory_test(iommu_t *iommu, char *data, uint64_t address, uint32_t size);
