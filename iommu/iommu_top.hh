...
public:
    ...
    iommu_top(sc_core::sc_module_name name) : sc_module(name),
        ...
        parser_to_dc_cache_query_fifo("parser_to_dc_cache_query_fifo", 8),
        parser_to_pc_cache_query_fifo("parser_to_pc_cache_query_fifo", 8),
        ...
        // DDR FIFOs
        xdtw_req_ddr_fifo("xdtw_req_ddr_fifo", 4),
        xdtw_rsp_ddr_fifo("xdtw_rsp_ddr_fifo", 4),
        ptw_req_ddr_fifo("ptw_req_ddr_fifo", 8),
        ptw_rsp_ddr_fifo("ptw_rsp_ddr_fifo", 8),
        msiptw_req_ddr_fifo("msiptw_req_ddr_fifo", 2),
        msiptw_rsp_ddr_fifo("msiptw_rsp_ddr_fifo", 2),
        ctrl_path_req_ddr_fifo("ctrl_path_req_ddr_fifo", 2),
