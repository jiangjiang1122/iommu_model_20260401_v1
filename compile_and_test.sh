...
echo "Compiling pt_cache.cpp..."
g++ $CXXFLAGS -c iommu/cache_src/cache/pt_cache.cpp -o build/iommu/cache_src/cache/pt_cache.o
...
echo "Running..."
./iommu_model 2>&1 | grep -A 20 "PT Cache Access Path"
